...
<CodeGroup>
```bash cURL
curl -X GET "https://api.mrdoge.co/odds/events?locale=en" \
...
response = requests.get('https://api.mrdoge.co/odds/events?locale=en', headers=headers)
```

```php PHP
<?php
$ch = curl_init('https://api.mrdoge.co/odds/events?locale=en');
...
| Standard events endpoint (`/odds/events`)                      | **1 credit**         |
| Trending events endpoint (`/odds/trending-events`)             | **2 credits**        |
| Specific event endpoint (`/odds/events/:eventId`)              | **1 credit**         |
| AI recommendations (`/ai/betting-recommendations`)             | **2 credits**        |
| AI predictions (`/ai/mr-doge-picks`)                           | **3 credits**        |
...
fetch("https://api.mrdoge.co/odds/events?locale=en", {
