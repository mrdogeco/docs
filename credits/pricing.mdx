...
<CardGroup cols={2}>
  ...
  <Card title="WHALE" icon="whale">
    **10,000,000 Credits**
    ...
    $0.10 per 1,000 credits

    **93% cheaper than STARTER**
...
| `GET /odds/events/:id/live-odds` | **2 credits** | Current live odds |
...
<Steps>
  ...
  <Step title="Choose Your Package">
    ...
    - **WHALE** (10,000,000 credits) - $999.90
...
<AccordionGroup>
  ...
  <Accordion title="Large Platform (20,000 credits/day)" icon="server">
    **Recommended Settings:**
    ...
    - Package: WHALE (10,000,000 credits)
    - Cost: $999.90 every ~495 days

    **Why this works:**
    - 5 days buffer
    - Recharges once every 16+ months
    - Best per-credit pricing
  </Accordion>
</AccordionGroup>
