---
title: "Get Mr. Doge Picks"
api: "GET https://api.mrdoge.co/v2/ai/mr-doge-picks"
auth: "bearer"
...
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/v2/ai/mr-doge-picks?today=true&limit=3"
```

```javascript JavaScript
const response = await fetch('https://api.mrdoge.co/v2/ai/mr-doge-picks?today=true&limit=3', {
  headers: {
...
response = requests.get(
    'https://api.mrdoge.co/v2/ai/mr-doge-picks',
    headers=headers,
