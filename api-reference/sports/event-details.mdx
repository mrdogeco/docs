---
title: "Event Details"
api: "GET https://api.mrdoge.co/v2/matches/{eventId}"
auth: "bearer"
...
<CodeGroup>
```bash cURL
curl "https://api.mrdoge.co/v2/matches/evt_abc123?locale=en"
```

```javascript JavaScript
const response = await fetch('https://api.mrdoge.co/v2/matches/evt_abc123?locale=en');
...
response = requests.get('https://api.mrdoge.co/v2/matches/evt_abc123?locale=en')
event = response.json()
print(event)
```
</CodeGroup>
