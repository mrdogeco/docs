...
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?date=2025-11-15&page=1&limit=100&locale=en"

# Page 2: Next 100 events (events 101-200)
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?date=2025-11-15&page=2&limit=100&locale=en"

# Page 3: Next 100 events (events 201-300)
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?date=2025-11-15&page=3&limit=100&locale=en"
```
...
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?startDate=2025-11-15&endDate=2025-11-22&page=1&locale=en"

# Week's events - Page 2
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?startDate=2025-11-15&endDate=2025-11-22&page=2&locale=en"
```
...
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?competitionId=847&page=1&locale=en"

# Premier League events - Page 2
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/odds/events?competitionId=847&page=2&locale=en"
```
